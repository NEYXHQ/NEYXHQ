...
import PaloAlt0VanillaNEYXPaloAlt0VanillaneyxToken from './Palo_Alt0/vanilla-NEYX/Palo_Alt0.vanillaneyx.token'
...
export default { 
  PaloAlt0VanillaNEYXPaloAlt0VanillaneyxToken: load(PaloAlt0VanillaNEYXPaloAlt0VanillaneyxToken, 'Palo_Alt0.vanillaneyx.token'),
